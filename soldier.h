...
struct Soldier{
    ...
    Soldier(int mH, int h, int r, int o, bool a, unsigned int id, std::string nM, Infantry_Ranged_Weapon pW, Infantry_Ranged_Weapon sW, Melee_Weapon k, Suit s, Boots cB): 
        MAX_HEALTH(mH), 
        Health(h), 
        RANK(r), 
        OCCUPATION(o), 
